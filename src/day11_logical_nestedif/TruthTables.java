...
public static void main(String[] args) {
	...
	System.out.println("When true || true result is " + (true || true));//true
	System.out.println("When true || false result is "+ (true || false));//truehttps://learn.cybertekschool.com/courses
	System.out.println("When false || true result is " + (false || true));//true
	System.out.println("When false || false result is " + (false || false));//falce
	
	System.out.println();
	
	System.out.println("##### TRUTH TABLES FOR ! (NOT) OPERATOR");
